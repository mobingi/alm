...
$content = file_get_contents(realpath(__DIR__ . '/../../..').'/markdown/enterprise/doc-rbac-release-history.md');
...
$("a[href='<?php echo $siteUrl; ?>enterprise/rbac-release-history']").parent('li').addClass("active");
</script>
