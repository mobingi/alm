...
$content = file_get_contents(realpath(__DIR__ . '/../../..').'/markdown/enterprise/doc-rbac-troubleshooting.md');
...
$("a[href='<?php echo $siteUrl; ?>enterprise/rbac-troubleshooting']").parent('li').addClass("active");
</script>
