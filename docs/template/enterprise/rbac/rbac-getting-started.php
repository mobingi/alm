...
$content = file_get_contents(realpath(__DIR__ . '/../../..').'/markdown/enterprise/doc-rbac-getting-started.md');
...
$("a[href='<?php echo $siteUrl; ?>enterprise/rbac-getting-started']").parent('li').addClass("active");
</script>
