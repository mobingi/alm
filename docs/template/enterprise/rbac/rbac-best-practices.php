...
$content = file_get_contents(realpath(__DIR__ . '/../../..').'/markdown/enterprise/doc-rbac-best-practices.md');
...
$("a[href='<?php echo $siteUrl; ?>enterprise/rbac-best-practices']").parent('li').addClass("active");
</script>
