...
$content = file_get_contents(realpath(__DIR__ . '/../../..').'/markdown/enterprise/doc-working-with-rbac.md');
...
$("a[href='<?php echo $siteUrl; ?>enterprise/working-with-rbac']").parent('li').addClass("active");
</script>
