...
$content = file_get_contents(realpath(__DIR__ . '/../../..').'/markdown/enterprise/doc-rbac-reference.md');
...
$("a[href='<?php echo $siteUrl; ?>enterprise/rbac-reference']").parent('li').addClass("active");
</script>
