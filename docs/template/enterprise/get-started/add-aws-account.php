...
$content = file_get_contents(realpath(__DIR__ . '/../../..').'/markdown/enterprise/get-started/add-aws-account.md');
...
<article class="col-sm-9 main-content" role="main">
    <header>
        <h1>How to Add Your AWS Account</h1>
    </header>
...
$("a[href='<?php echo $siteUrl; ?>enterprise/get-started/add-aws-account']").parent('li').addClass("active");
</script>
