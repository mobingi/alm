...
$content = file_get_contents(realpath(__DIR__ . '/../..').'/markdown/alm-rbac/doc-alm-rbac-release-history.md');
...
$("a[href='<?php echo $siteUrl; ?>alm-rbac-release-history']").parent('li').addClass("active");
</script>
