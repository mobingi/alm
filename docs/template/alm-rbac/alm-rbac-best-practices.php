...
$content = file_get_contents(realpath(__DIR__ . '/../..').'/markdown/alm-rbac/doc-alm-rbac-best-practices.md');
...
$("a[href='<?php echo $siteUrl; ?>alm-rbac-best-practices']").parent('li').addClass("active");
</script>
