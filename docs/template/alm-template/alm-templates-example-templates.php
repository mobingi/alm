...
$content = file_get_contents(realpath(__DIR__ . '/../..').'/markdown/alm-template/doc-alm-templates-example-templates.md');
...
$("a[href='<?php echo $siteUrl; ?>alm-templates-example-templates']").parent('li').addClass("active");
</script>
