...
$content = file_get_contents(realpath(__DIR__ . '/../..').'/markdown/alm-template/doc-alm-templates-troubleshooting.md');
...
$("a[href='<?php echo $siteUrl; ?>alm-templates-troubleshooting']").parent('li').addClass("active");
</script>
