...
$content = file_get_contents(realpath(__DIR__ . '/../..').'/markdown/alm-template/doc-working-with-alm-templates.md');
...
<article class="col-sm-9 main-content" role="main">
    <header>
        <h1>Working with ALM Templates</h1>
    </header>
...
$("a[href='<?php echo $siteUrl; ?>working-with-alm-templates']").parent('li').addClass("active");
</script>
