...
$content = file_get_contents(realpath(__DIR__ . '/../..').'/markdown/alm-template/doc-alm-template-best-practices.md');
...
$("a[href='<?php echo $siteUrl; ?>alm-template-best-practices']").parent('li').addClass("active");
</script>
