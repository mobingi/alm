...
$content = file_get_contents(realpath(__DIR__ . '/../..').'/markdown/container/verified-docker-images.md');
...
<article class="col-sm-9 main-content" role="main">
    <header>
        <h1>Mobingi Verified Docker Images</h1>
    </header>
...
$("a[href='<?php echo $siteUrl; ?>container/verified-docker-images']").parent('li').addClass("active");
</script>
