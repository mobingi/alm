...
$content = file_get_contents(realpath(__DIR__ . '/../..').'/markdown/container/custome-actions.md');
...
$("a[href='<?php echo $siteUrl; ?>container/custome-actions']").parent('li').addClass("active");
</script>
