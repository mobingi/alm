...
$content = file_get_contents(realpath(__DIR__ . '/../..').'/markdown/container/overview.md');
...
<article class="col-sm-9 main-content" role="main">
    <header>
        <h1>Overview - Mobingi ALM Container</h1>
    </header>
...
$("a[href='<?php echo $siteUrl; ?>container']").parent('li').addClass("active");
</script>
